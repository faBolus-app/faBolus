...
/// categories honor disable/rate-limit/snooze, and that each message uses its own dedupeKey. A shared id would collapse distinct remote-bolus rejections onto one banner.
@MainActor
