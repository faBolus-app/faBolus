    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("**Advisory only** — never blocks or changes a dose. The bolus guardrail warns when a dose looks likely to cause a low or is stacking on active insulin. Off by default. Retrospective insights are under Data & History.")
            }
        }
