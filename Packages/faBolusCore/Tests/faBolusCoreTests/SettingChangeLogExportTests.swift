...
struct SettingChangeLogExportTests {
    ...
    private func seeded() -> SettingChangeLog {
        ...
        log.record(StoredSettingChange(key: .global("maxBolus"), before: nil, after: .double(12),
                                       provenance: .consensusDefault, atSeconds: 1_700_000_000), cap: 512)
        log.record(StoredSettingChange(key: .segment(idpId: 0, startMinutes: 480, field: "isf"),
