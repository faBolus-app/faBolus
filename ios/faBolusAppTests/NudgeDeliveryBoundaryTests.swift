...
struct NudgeDeliveryBoundaryTests {
    ...
    @Test func nudgeSourceContainsNoDeliverySeamSymbols() throws {
        ...
        // wrapping the call onto multiple lines, where the call-shape token would not. It appears
        // ONLY on TandemBackend's signed-write entry point, so it cannot false-positive here.
