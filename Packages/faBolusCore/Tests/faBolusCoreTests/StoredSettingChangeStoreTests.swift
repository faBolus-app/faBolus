...
struct StoredSettingChangeStoreTests {
    ...
    private func change(
        _ key: SettingKey, before: BackupValue?, after: BackupValue,
        _ prov: SettingProvenance, at: Int
    ) -> StoredSettingChange {
    ...
    @Test func saveThenLoadRoundTrips() throws {
        ...
        log.record(
            change(
                .segment(idpId: 1, startMinutes: 480, field: "basalRate"),
    ...
    @Test func provenanceIsKeyedOnStartTimeSoSegmentRenumberIsStable() {
        ...
        log.record(
            change(
                .segment(idpId: 1, startMinutes: 0, field: "basalRate"),
